package mintic.edu.proyecto.conexion;
...
public class conexion_database {
    ...
    Statement consulta;
    private static final String URL = "jdbc:mysql://localhost:3307/proyecto?useSSL=false&serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8"; {
